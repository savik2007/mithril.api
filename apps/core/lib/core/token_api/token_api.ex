defmodule Core.TokenAPI do
  ...
  alias Core.TokenAPI.TokenSearch
  alias Core.UserAPI
  ...
  defp deactivate_old_tokens_where_name_clause(query, name)
       when name in [@access_token, @access_token_2fa] do
  ...
  defp get_token_lifetime, do: Confex.fetch_env!(:core, :token_lifetime)
end
