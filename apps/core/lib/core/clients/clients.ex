defmodule Core.Clients do
  ...
  alias Core.Clients.ClientSearch
  alias Core.Clients.Connection
  alias Core.Clients.ConnectionSearch
  alias Core.Repo
  alias Ecto.UUID
  ...
  def validate_connection_context(%Connection{consumer_id: consumer_id}, _client_id, api_key)
  ...
  def validate_connection_context(_, _, _),
    do: {:error, {:access_denied, "api-key header not set"}}
end
