defmodule Core.Ecto.Fixtures do
  @moduledoc false
  alias Ecto.Adapters.SQL

  def ensure_fixtures do
    queries = create_or_update_client_types_queries() ++ create_or_update_roles_queries()

    Enum.each(queries, &SQL.query(Core.Repo, &1))
  end
  ...
  defp fixtures_dir(path) do
    Application.app_dir(:core, "priv/repo/fixtures/#{path}")
  end
